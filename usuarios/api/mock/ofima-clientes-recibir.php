<?php
/**
 * Mock local de la API de Ofima para pruebas Orion → Ofima (clientes).
 * Recibe POST (crear) y PUT (actualizar) cliente, registra el payload en log y responde 200.
 *
 * Uso: En api_configuracion, para clientes / orion_ofima, poner como apic_url_endpoint:
...
$logDir = __DIR__;
$logFile = $logDir . '/log-ofima-clientes.txt';
...
echo json_encode([
    'success' => true,
    'message' => 'Mock Ofima: cliente recibido (prueba local)',
    'metodo'  => $metodo
]);
