...
$resultadoD = mysqli_fetch_array($consultaBodegas, MYSQLI_BOTH);
?>
<!-- styles -->
			...
			<div class="row-fluid ">
				...
				<?php
					if (Modulos::validarRol([143], $conexionBdPrincipal, $conexionBdAdmin, $datosUsuarioActual, $configuracion)) {
						echo '<p><a href="bodegas-agregar.php" class="btn btn-danger"><i class="icon-plus"></i> Agregar nuevo</a></p> ';
					}
				?>
				...
				<div class="span12">
					<div class="content-widgets gray">
						...
						<div class="widget-container">
							<form class="form-horizontal" method="post" action="bd_update/bodegas-actualizar.php">
                            	<input type="hidden" name="id" value="<?=$_GET["id"];?>">
                                <div class="control-group">
									<label class="control-label">Nombre de la bodega</label>
									<div class="controls">
										<input type="text" class="span6" name="nombre" value="<?=$resultadoD['bod_nombre'];?>">
									</div>
								</div>
                                <div class="control-group">
									...
									<div class="controls">
										<select data-placeholder="Escoja una opción..." class="chzn-select span4" tabindex="2" name="ciudad">
											...
											?>
                                            	<option value="<?=$resOp['ciu_id'];?>" <?php if($resultadoD['bod_ciudad']==$resOp['ciu_id']){echo "selected";}?>><?=$resOp['ciu_nombre'].", ".$resOp['dep_nombre'];?></option>
                                            <?php
											}
											?>
                                    	</select>
