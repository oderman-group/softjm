...
if (!Modulos::validarRol([12], $conexionBdPrincipal, $conexionBdAdmin, $datosUsuarioActual, $configuracion)) {
    http_response_code(403);
    echo json_encode(['success' => false, 'message' => 'No tiene permisos para ver los seguimientos del ticket.']);
    exit;
}
...
$detalle = ClienteSeguimiento::obtenerTicketConSeguimientosDrawer(
    $ticketId,
    $clienteId,
    intval($idEmpresa),
    $conexionBdPrincipal
