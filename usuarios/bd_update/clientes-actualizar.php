...
if (isset($_POST["usuario"]) and trim($_POST["usuario"]) != "") {
    $consultaClienteV = $conexionBdPrincipal->query("SELECT * FROM clientes 
    WHERE cli_usuario='" . trim($_POST["usuario"]) . "' AND cli_id!='" . $_POST["id"] . "'");
...
if (isset($_POST["grupos"])) {
    $conexionBdPrincipal->query("DELETE FROM clientes_categorias 
    WHERE cpcat_cliente='" . $_POST["id"] . "'");
...
if ($_POST["asesor"] != "") {
    $conexionBdPrincipal->query("DELETE FROM clientes_usuarios 
    WHERE cliu_cliente='" . $_POST["id"] . "'");
