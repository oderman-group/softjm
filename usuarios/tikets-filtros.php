...
<?php
$idPagina = 107;
$paginaActual['pag_nombre'] = "Filtro tickets de clientes";
?>
			...
			<div class="row-fluid ">
				<div class="span12">
					...
					<ul class="breadcrumb">
                        ...
                        <li><a href="clientes-tikets.php">Tickets de clientes</a><span class="divider"><i class="icon-angle-right"></i></span></li>
				...
				<div class="span12">
					<div class="content-widgets gray">
						...
						<div class="widget-container">
							<form class="form-horizontal" method="post" action="reportes/tikets-reporte.php" target="_blank">  
                               ...
                               <div class="control-group">
									...
									<div class="controls">
										<select data-placeholder="Escoja una opción..." class="chzn-select span4" tabindex="2" name="tipoTK">
											<option value="">Todos</option>
                                ...
                                <div class="control-group">
									...
									<div class="controls">
										<select data-placeholder="Escoja una opción..." class="chzn-select span4" tabindex="2" name="orden">
											<option value="tik_id"></option>
                                            <option value="tik_usuario_responsable">Usuario responsable</option>
                                            <option value="tik_cliente">Cliente</option>
                                            <option value="tik_tipo_tiket">Tipo de ticket</option>
                                            <option value="tik_canal">Canal</option>
                                    	</select>
                                    </div>
                               </div>
