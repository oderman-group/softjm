      ...
      <div class="brand-logo">
        <?php if(USE_ICON_AS_LOGO): ?>
          <div style="display: flex; align-items: center; justify-content: center; gap: 16px;">
            <i class="<?= BRAND_LOGO_ICON ?>" style="font-size: 48px; color: #48bb78;"></i>
            <h2 style="font-size: 42px; font-weight: 800; margin: 0; background: linear-gradient(135deg, #48bb78 0%, #38b2ac 100%); -webkit-background-clip: text; -webkit-text-fill-color: transparent; background-clip: text;"><?= BRAND_NAME ?></h2>
          </div>
        <?php else: ?>
